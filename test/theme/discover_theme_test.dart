...
/// Same wide pattern as the chat gate — the original profile gate banned
/// white|black|grey and nothing else, so Colors.blue and Colors.amber passed a
...
void main() {
  test('the Discover surface uses semantic tokens, not colour literals', () {
    final offenders = <String>[];
    final targets = <FileSystemEntity>[
      ...Directory('lib/screens/discover').listSync(recursive: true),
